...
public interface MessageBus {
    ...
    <T> List<MicroService> getSubscribedMicroServiceMessage(Class<? extends Message> type);
    BlockingQueue getRegisteredMicroServiceQueue(MicroService service);
    boolean isMicroServiceRegistered(MicroService service);
    <T> boolean isInMicroServiceMessageQueue(Message e, MicroService m);
    Map<Event<?>, Future> getFuturesAssociatedWithEvents();
